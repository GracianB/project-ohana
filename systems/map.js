...
export const ROOMS = {
  hub: {
    ...
    hint: "Recoge orbes. ESTE costa. OESTE cueva. ARRIBA cumbre.",
  ...
  beach: {
    ...
    pit: true,
    hint: "El hueco del centro es POZO mortal. Forma 2 abre ESTE.",
  ...
  jungle: {
    ...
    needEvo: 1,
    hint: "Forma 3: salta ARRIBA a la caldera. No hay pozo abajo.",
  ...
  ridge: {
    ...
    hint: "ESTE orbita. Para bajar al claro: ponte en ABAJO y pulsa S.",
    plats: [[0, 810, 1600, 90], [200, 660, 160, 18], [500, 520, 150, 18], [1040, 620, 160, 18]],
  ...
  space: {
    ...
    needEvo: 1,
    pit: true,
    hint: "El pozo baja al CLARO, no a la caldera. Caldera = Jungla ARRIBA.",
  ...
  volcano: {
    ...
    needEvo: 2,
    hint: "ESTE es el nido. Se llega desde Jungla ARRIBA.",
  ...
  boss: {
    ...
    needEvo: 2,
    hint: "Tumba al nido. Al caer, contacta a Jun.",
