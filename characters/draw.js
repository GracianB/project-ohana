...
function drawMushu(ctx, p, t, evo) {
  ...
  ctx.fillStyle = red;
  ctx.beginPath();
  ctx.ellipse(-2, 8, 14, 9.5, -0.25, 0, 0, Math.PI * 2);
  ctx.fill();
  ctx.fillStyle = cream;
  ctx.beginPath();
  ctx.ellipse(0, 10, 9, 5.2, -0.25, 0, 0, Math.PI * 2);
  ctx.fill();
  ...
  ctx.fillStyle = red;
  ctx.beginPath();
  ctx.ellipse(10, -2, 13, 11, 0.18, 0, 0, Math.PI * 2);
  ctx.fill();
  ctx.fillStyle = cream;
  ctx.beginPath();
  ctx.ellipse(12, 2, 8, 5.5, 0.18, 0, 0, Math.PI * 2);
  ctx.fill();
  ctx.fillStyle = gold;
  ctx.beginPath();
  ctx.moveTo(4, -10);
  ...
  ctx.beginPath();
  ctx.ellipse(7, -3, 3.6, 4.4, -0.2, 0, 0, Math.PI * 2);
  ctx.fill();
  ctx.beginPath();
  ctx.ellipse(15, -3.2, 3.6, 4.4, 0.15, 0, 0, Math.PI * 2);
  ctx.fill();
  ...
  ctx.fillStyle = dark;
  ctx.beginPath();
  ctx.ellipse(20, 2, 3.6, 2.4, 0.35, 0, 0, Math.PI * 2);
  ctx.fill();
  if (evo >= 2) {
